...
CH_nearField = 0;
CH_farField = 1;
pathToData = 'Our Data/Two Speakers';
fs = 20000;
...
analyzeDirectivity_DoubleSource(farFieldArray,angles,[100,1000,4000,6000],"Far");
analyzeDirectivity_DoubleSource(nearFieldArray,angles,[100,1000,4000,6000],"Near");
